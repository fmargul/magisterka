...
main(int argc, char* argv[])
{
    ...
    staDevices3 = wifi.Install(phy, mac, wifiStaNodes3);
    ...
    mac.SetType("ns3::ApWifiMac",
                ...
                "Ssid",
                SsidValue(ssid));
    apDevice3 = wifi.Install(phy, mac, wifiApNode3);
    ...
    staDevices4 = wifi.Install(phy, mac, wifiStaNodes4);
    ...
    mac.SetType("ns3::ApWifiMac",
                ...
                "Ssid",
                SsidValue(ssid));
    apDevice4 = wifi.Install(phy, mac, wifiApNode4);
    ...
    if (udp)
    {
        ...
        const auto packetInterval = 1528 * 8.0 / (dataRate * 1024 * 1024);
